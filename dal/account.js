...
exports.GetByID = function(account_id, callback) {
    ...
    var query = 'SELECT * FROM accounts WHERE account_id=' + account_id;
    console.log(query);
...
exports.Insert = function(account_info, callback) {
     ...
     */
    var dynamic_query = 'INSERT INTO accounts (FirstName, LastName, email, password, address) VALUES (' +
...
exports.GetAddress = function(account_id, callback){
    ...
    var query = 'SELECT address FROM accounts WHERE account_id = ' + account_id;
...
exports.AddAddress = function(info, callback) {
    ...
    var query_data = [info.address, info.account_id];
    console.log(query_data);

    //var query = 'INSERT INTO account (account_id, address) VALUES (?, ?)';
    var query = 'UPDATE accounts SET address=? WHERE account_id=?';
...
exports.DeleteAccount = function(info, callback) {
    ...
    var query_data = [info.account_id];
    console.log(query_data);

    var query = 'DELETE from accounts WHERE account_id=?'; //UPDATE account SET address=? WHERE account_id=?';
